...
signalScriptCfg = {
  ...
  'ext':'highmass_%s_200-400'%_year,
  'analysis':'highMassAnalysis', # To specify which replacement dataset mapping (defined in ./python/replacementMap.py)
  'year':'%s'%_year, # Use 'combined' if merging all years: not recommended
  'massPoints':'250,300,350', #250,300,350,400,450,500 ,#'130,150,200,250,300,350,400,450,500,550,600,650,700,750,800,900,1000,1250,1500,1750,2000,2250,2500,3000',
